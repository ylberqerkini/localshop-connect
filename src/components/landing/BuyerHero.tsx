...
const BuyerHero = () => {
  ...
  return (
    <div className="pt-16">
                ...
                <CarouselItem key={i}>
                  ...
                  >
                    ...
                    <div className="relative max-w-lg">
                      ...
                      <Button
                        onClick={() => navigate("/marketplace")}
                        className="bg-white text-foreground hover:bg-white/90 rounded-full px-6 font-semibold"
                      >
                        {slide.cta}
                      </Button>
                    </div>
      ...
      {/* Search bar - prominent eBay style */}
      ...
      {/* Category grid - eBay "The future in your hands" style */}
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4">
            {roots.slice(0, 8).map((cat) => {
              ...
              return (
                ...
                >
                  <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-muted/60 flex items-center justify-center group-hover:bg-primary/10 transition-colors border border-border/50 group-hover:border-primary/30">
      ...
      {/* Deals section - eBay "Today's Deals" style */}
      ...
      {/* Featured / New Products - eBay style grid */}
      <section className="py-10 bg-background">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl sm:text-2xl font-bold text-foreground">
